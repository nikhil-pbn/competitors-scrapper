...
import { DARK_CLASS, THEME_STORAGE_KEY, type Theme } from "@/components/theme/theme";
...
/**
 * Theme boundary for the app tree. State lives in the module store above (read
 * via useSyncExternalStore in `useTheme`), so this simply renders its children.
 */
